...
<button class="gallery-user" onclick="location.href='photo_album.php';">Gallery</button>
</div>
...
if (mysqli_num_rows($show_result)) {
           ...
           <span class="user-icn-img">
           	<a href="about-fr.php?id=<?= $row['pet_unique_id'] ?>"><?php if($row['profile_pic']=="") {
							echo "<img src='images/fr-pro-big-img.jpg'>";
							}
							else {
							?>
                        ...
                        <div class="fr-list fr-req">
                            ...
                            <div class="fr-li-cont" id="friend-req-show">
                                <div class="fr-li-row">
                                    <div class="fr-t-l">
                                        ...
                                        <a href="about-fr.php?id=<?= $frnd_req['pet_unique_id'] ?>"><span class="user-icn-img">
							...
							<img src="<?= $frnd_req['profile_pic'] ?>" alt="user image" />
								<?php } ?>                                        	
                                    ...
                                    <div class="user-nm"><a href="about-fr.php?id=<?= $frnd_req['pet_unique_id'] ?>" class="frn_req_acc" id="<?=$frnd_req['parent_id'] ?>">Accept</a><a href="#" class="frn_req_rej" id="<?=$frnd_req['parent_id'] ?>">Reject</a></div>
                                </div>
