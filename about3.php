...
<!--								<a href="message-friend.php?id=<//?= $_GET['id']; ?>" class="msg_friend_bttn" id="msg-frnd">Message</a>-->
...
<?php
		...
		<?php $user_like=mysqli_query($conn,"SELECT * FROM likes WHERE post_id='$propost[id]' AND liker_unique_id='$parent_id'"); 
										...
										<?php } ?>
												...
												<span class="number-likes<?= $propost['id'] ?>"><?= $likenum ?></span> Likes</p>						<!--Social sharing code start here-->
<!--Facebook-->
<?php
...
<div class="temp-ads-cl"><?php require_once 'inc/ads_sidebar_d.php'; ?></div>
