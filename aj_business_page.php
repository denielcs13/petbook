...
<?php } ?>
                                ...
                                <div class="post-box-right">
										 ...
										 <a href="<?= $postres['url'] ?>" target="blank">
		 <h3><?= $postres['title'] ?></h3>
