...
$display = "SELECT * FROM post WHERE (child_post_id = '$parent_id' OR child_post_id IN (SELECT group_id FROM business_like WHERE user_id =  '$parent_id' AND STATUS = '1' UNION SELECT ngo_id FROM ngo_like WHERE user_id ='$parent_id' AND STATUS = '1')) AND (type!='shared' OR share_with='$parent_id') ORDER BY id DESC";
...
<?php
$folqry=mysqli_query($conn,"SELECT user_inf.pet_unique_id,user_inf.pet_name,user_inf.profile_pic,'user' AS source FROM business_like JOIN user_inf on user_inf.pet_unique_id=business_like.user_id WHERE group_id='$parent_id' AND business_like.status='1' UNION SELECT business.business_uniqueid,business.company_name,business.profile_image,'business' AS source FROM business_like JOIN business on business.business_uniqueid=business_like.user_id WHERE group_id='$parent_id' AND business_like.status='1' UNION 
SELECT ngo_resgitration.ngo_unique_id,ngo_resgitration.ngo_name,ngo_resgitration.profile_image,'ngo' AS source FROM business_like JOIN ngo_resgitration on ngo_resgitration.ngo_unique_id=business_like.user_id WHERE group_id='$parent_id' AND business_like.status='1'");    
...
<span class="fr-nm">
<?php if($foll['source']=='user') { ?>
<a href="about3.php?id=<?= $foll['pet_unique_id'] ?>" class="frn_profile"><?= $foll['pet_name'] ?></a>
<?php } if($foll['source']=='business') { ?>
<a href="business-page-new-user.php?id=<?= $foll['pet_unique_id'] ?>" class="frn_profile"><?= $foll['pet_name'] ?></a>
<?php } if($foll['source']=='ngo') { ?>
<a href="ngo-page-new-user.php?id=<?= $foll['pet_unique_id'] ?>" class="frn_profile"><?= $foll['pet_name'] ?></a>
<?php } ?>
...
<?php
 ...
 ?>
						 ...
						 $(this).find('#alertmsg').append('<span class="frmalert" id="form-alert">Your Post is Blank.Please write something or attach media</span>');
                        ...
                        <div class="modal-body">
                            <div class="fr-li-cont">
                                <form method="post" id="share-form">
                                    <?php
                     $friendqry = "SELECT user_inf.pet_unique_id,user_inf.pet_name,user_inf.profile_pic FROM business_like JOIN user_inf on user_inf.pet_unique_id=business_like.user_id WHERE group_id='$parent_id' AND business_like.status='1' UNION SELECT business.business_uniqueid,business.company_name,business.profile_image FROM business_like JOIN business on business.business_uniqueid=business_like.user_id WHERE group_id='$parent_id' AND business_like.status='1' UNION SELECT ngo_resgitration.ngo_unique_id,ngo_resgitration.ngo_name,ngo_resgitration.profile_image FROM business_like JOIN ngo_resgitration on ngo_resgitration.ngo_unique_id=business_like.user_id WHERE group_id='$parent_id' AND business_like.status='1'";
