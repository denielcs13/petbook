        ...
        for ($i = 0; $i < count($post_images); $i++) {
            ?>
                                        ...
                                        <li class="pb-image-box">
                                            <a href="aj_business_page.php?id=<?= $postres['id'] ?>&gid=<?= $_GET['id'] ?>&im=<?= $post_images[$i] ?> .ajcontent" data-featherlight="ajax">
    ...
    if ($postres['vid_count'] > 0) {
        ...
        for ($i = 0; $i < count($post_videos); $i++) {
            ?>
                                        ...
                                        <li class="pb-image-box">
                                            <a href="aj_business_page.php?id=<?= $postres['id'] ?>&gid=<?= $_GET['id'] ?>&vid=<?= $post_videos[$i] ?> .ajcontent" data-featherlight="ajax">
                                                <video controls>
