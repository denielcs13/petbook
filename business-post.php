...
$im_count=0;
$vid_count=0;
$loc_path = $_SESSION['business_unique_id']."/post_images/";   
$vid_loc_path =  $_SESSION['business_unique_id']."/Videos/";
...
if ($conn->query($savepost) === TRUE) {
	...
	if($im_count>0) {
	foreach($all_images as $mediaimg) {
$mediaqry=mysqli_query($conn,"INSERT INTO post_media(post_id,image)VALUES('$posted_id','$mediaimg')");
	}
}
if($vid_count>0) {
foreach($all_videos as $mediavid) {
$mediaqry=mysqli_query($conn,"INSERT INTO post_media(post_id,video)VALUES('$posted_id','$mediavid')");
	}
}
