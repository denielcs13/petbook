<html>
    <?php require_once 'inc/head-content-ngo.php'; ?>
    <body  class="otp-ver">
        ...
        if (isset($_POST['user_submit'])) {
			...
			if (empty($country_code)) {
                $error_country_code = "Select code";
            }
            if (empty($mobile)) {
                ...
                if (mysqli_num_rows($res) == 1) {
                 echo "<script>alert('Already exist')</script>";
                   ...
                   //print_r($random_number);
                    ...
                    $subject = "Petbooq verification NGO";
...
You recently registered for Petbooq.$ngo_name
</div>
...
<div href='#' style='display:inline-block;width:100%;padding:5px 0;background-color:#6d6e72;color:#fff;text-transform:uppercase;font-size:23px;text-decoration:none;text-align:center;font-weight:bold;'>".$_SESSION['otp']."</div>
</div>
</div>
</div>
</div>
...
";
                    ...
                    $otp_verification = "Insert into otp_verfication(otp,email,createdOn) value (" . $_SESSION['otp'] . ",'$ngo_email',NOW())";
                        ...
                        echo "<script>window.location='otp-ngo.php'</script>";
//                    }
                }
            }
        }
        ...
        ?>
        <div class="main-content register-page ngo-register-page">
...
?></div>
                                ...
                                <select name="ngo_type" id="ngo_type">
                                    ...
                                    <option value="Non-Profit Organisation" Selected>Non-Profit Organization</option>                                    
                                </select>
<?php
...
<!--                                    <label>Phone No.</label> -->
									<input type="number" placeholder="Phone No." class="mid" name="mobile" id="mobile"/>
										<?php
