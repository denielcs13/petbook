                ...
                <div class="main-content-inn-left">
                    <div class="col-first">
                       <div class="two-col-post">
                         <h2 class="fr-heading"><span class="fr-h-l">ReHome a Pet List</span> <span class="fr-inp-l"><input type="text" name="search" placeholder="Search" id="search"></span></h2>

<?php

require './dbcon.php';
$query_fetchs = "select * from pet_rehome";
 ...
 ?>
                                    <div class="left friend-box">
                                        <div class="post-in-c">
                                            <div class="fr-left">
                                                <div class="fri-image">
                                                    <a href="rehome-about.php?id=<?= $row['id'] ?>">
                                                        <?php
                                                        if ($row['pet_photo'] == "") {
                                            ...
                                            <div class="fr-right">
                                                <div class="fri-name">
                                                    <p class="ttl-lks"><a href="rehome-about.php?id=<?= $row['id'] ?>"><?= $row['pet_name'] ?></a></p>
                                                </div>
