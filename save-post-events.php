...
$im_count=0;
$vid_count=0;
$loc_path = $uniqueid."/Events/".$event_name."/post_images/";   
$vid_loc_path =  $uniqueid."/Events/".$event_name."/Videos/";
...
$savepost="INSERT INTO event_updates(user_id_fk,event_id_fk,title,event_data,url,created)VALUES('$uniqueid','$event_id','$title','$description','$addlink','$post_datetime' )";
	
}
else {
$savepost="INSERT INTO event_updates(user_id_fk,event_id_fk,title,event_data,url,image,img_count,video,vid_count,created)VALUES('$uniqueid','$event_id','$title','$description','$addlink','$im_path','$im_count','$vid_path','$vid_count','$post_datetime')";
}
...
$disp_post=mysqli_query($conn,"SELECT * FROM event_updates WHERE e_update_id='$posted_id'");
  ...
  <source src="<?= $post_videos[$i] ?>" type="video/mp4">
											...
											<div class="post-content">
                                                <h2><span class="user-icn-img"><img src="images/user-img-icon.png" alt="user image" /></span>
                                                    <p class="user-nm"><a href="#"><?= $_POST['event-name'] ?></a></p></h2>
                                                <p class="pst-text"><?= $display_post['event_data'] ?><p>
