...
$im_count=0;
$vid_count=0;
$loc_path = $uniqueid."/Groups/".$group_name."/post_images/";   
$vid_loc_path =  $uniqueid."/Groups/".$group_name."/Videos/";
...
$savepost="INSERT INTO updates(user_id_fk,group_id_fk,title,post_data,url,created)VALUES('$uniqueid','$group_id','$title','$description','$addlink','$post_datetime' )";
	
}
else {
$savepost="INSERT INTO updates(user_id_fk,group_id_fk,title,post_data,url,image,img_count,video,vid_count,created)VALUES('$uniqueid','$group_id','$title','$description','$addlink','$im_path','$im_count','$vid_path','$vid_count','$post_datetime')";
}
...
$disp_post=mysqli_query($conn,"SELECT * FROM updates WHERE update_id='$posted_id'");
...
<div class="multi-pimg">
  ...
  <source src="<?= $post_videos[$i] ?>" type="video/mp4">
											...
											<div class="post-content">
                                                ...
                                                <p class="pst-text"><?= $display_post['post_data'] ?><p>
